# Hi, I'm Rehab 👋
CS student at NASTP Institute of Information Technology (NIIT), Lahore. Currently in my 2nd year (3 semesters completed) with a focus on C++, OOP, networking, and the MERN stack — deliberately going wide across programming, web development, networking, and AI before picking a lane.
...
| [Echos and Ink](https://funny-pothos-a58c9d.netlify.app/) | Web App · C++ | Live, publicly deployed on Netlify |
...
## Stack
**Languages & Paradigms** — C++ · HTML · MERN Stack · OOP (Encapsulation, Inheritance, Polymorphism, Abstraction)  
**Networking** — OSI Model · IP Addressing · Subnetting · Routing Basics · Cisco Packet Tracer  
**Tools** — VS Code · Dev-C++ · Git · CLI · Data Structures & Algorithms · Debugging
